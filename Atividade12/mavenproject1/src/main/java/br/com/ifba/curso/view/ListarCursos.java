...
public void recarregarTabela() {
    ...
    public void actionPerformed(ActionEvent e) {
        recarregarTabela();
        JOptionPane.showMessageDialog(ListarCursos.this, "Lista atualizada!");
    }
});

        // Ação para simular a busca
        // A busca é o RETRIEVE com filtro
    ...
    public void actionPerformed(ActionEvent e) {
        try {
            ...
            if (termo.isEmpty() || termo.equalsIgnoreCase("Procurar...")) {
                throw new IllegalArgumentException("Digite um termo para buscar.");
            }

            List<Curso> cursosEncontrados = cursoDAO.buscarPorNome(termo);

            if (cursosEncontrados.isEmpty()) {
                JOptionPane.showMessageDialog(ListarCursos.this, 
                    "Nenhum curso encontrado com o termo: " + termo, 
            ...
            JOptionPane.showMessageDialog(ListarCursos.this, ex.getMessage(), 
                "Aviso", JOptionPane.WARNING_MESSAGE);
        } catch (Exception ex) {
            JOptionPane.showMessageDialog(ListarCursos.this, 
                "Erro ao realizar a busca: " + ex.getMessage(), 
    ...
    private void adicionarAcoesTabela() {
        ...
        tabelaCursos.addMouseListener(new MouseAdapter() {
            ...
            public void mouseClicked(MouseEvent evt) {
                ...
                try{
                    int resposta =JOptionPane.showConfirmDialog(ListarCursos.this, "Deseja excluir o curso? '" + nomeCurso + 
                            "'(ID: "+ idCurso +")?", "Confirmar exclusão", JOptionPane.YES_NO_OPTION);
                    
                    if(resposta != JOptionPane.YES_NO_OPTION) return;
                    ...
                    // Erros de validação, como ID inválido
                    JOptionPane.showMessageDialog(ListarCursos.this, ex.getMessage(), 
                      "Aviso", JOptionPane.WARNING_MESSAGE);
                    } catch (jakarta.persistence.PersistenceException pe) {
                       // Problemas de banco de dados
                    JOptionPane.showMessageDialog(ListarCursos.this, 
                    "Erro no banco de dados ao remover o curso.\n" + pe.getMessage(), 
                    "Erro", JOptionPane.ERROR_MESSAGE);
                      pe.printStackTrace();
                    } catch (Exception e) {
                    // Qualquer outro erro inesperado
                    JOptionPane.showMessageDialog(ListarCursos.this, 
                    "Erro inesperado ao remover o curso.\n" + e.getMessage(), 
                    "Erro", JOptionPane.ERROR_MESSAGE);
                    e.printStackTrace();
                 }
                ...
                if (coluna == 6) { 
                    try{
                        if(idCurso == null){
                         ...
                         Curso cursoSelecionado = cursoDAO.buscarId(idCurso);
                         
                        if(cursoSelecionado == null){
                               throw new IllegalArgumentException("Curso não encontrado no banco de dados.");                            
                        }
                          TelaPrincipal telaEdicao = new TelaPrincipal(ListarCursos.this, cursoSelecionado);
                          telaEdicao.setVisible(true);
                             ...
                             JOptionPane.showMessageDialog(ListarCursos.this, 
                             "Erro ao buscar curso no banco.\n" + pe.getMessage(), 
                             "Erro", JOptionPane.ERROR_MESSAGE);
                              pe.printStackTrace();
                        }catch (Exception e) {
                              JOptionPane.showMessageDialog(ListarCursos.this, 
                              "Erro inesperado ao abrir a tela de edição.\n" + e.getMessage(), 
                              "Erro", JOptionPane.ERROR_MESSAGE);
                                e.printStackTrace();
                }  
